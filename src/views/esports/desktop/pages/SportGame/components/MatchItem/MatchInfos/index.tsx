...
export default React.memo(({match, playMethod}: IProps) => {
  ...
  return (
    <>
      ...
      <div className={classnames(styles.team_info, 'pointer')} onClick={onOpen}>
        <div className='team'>
          <DpImage sportId={match.sportId} type='team' src={match.teams.home.icon} />
          <div
        ...
        <div className='team'>
          <DpImage sportId={match.sportId} type='team' src={match.teams.away.icon} />
          <div
          ...
          <div className='play-total flex items-center' onClick={onOpen}>
            <Tooltip title='全部玩法'>
              <div className='flex items-center'>
                <div>+{match.playTypeCount}</div>
                <DpIcon type='arrow' />
              </div>
            </Tooltip>
          </div>
          {match.competitionType && <div className='competition-type'>{match.competitionType}</div>}
        </div>
      </div>
    </>
  );
