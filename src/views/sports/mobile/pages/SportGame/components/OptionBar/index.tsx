          ...
          icon:
            i.code === sortBy ? (
              <img
                ...
                src={require(`@my/assets/images/common/icon_filter_sel${
                  theme === ETHEME.DARK ? "_1" : ""
                }.png`)}
              />
            ) : (
              <img
                className="sort-by-icon"
                src={require("@my/assets/images/common/icon_filter_nor.png")}
              />
            ),
        }))}
        checked={sortBy}
